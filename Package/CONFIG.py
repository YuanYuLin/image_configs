...
def MAIN_EXTRACT(args):
    ...
    ops.copyto(ops.path_join(pkg_path, "group"), output_dir)
    ops.copyto(ops.path_join(pkg_path, "inittab"), output_dir)
    ops.copyto(ops.path_join(pkg_path, "printcap"), output_dir)
...
def MAIN_INSTALL(args):
    ...
    iopc.installBin(args["pkg_name"], ops.path_join(output_dir, "group"), "etc")
    iopc.installBin(args["pkg_name"], ops.path_join(output_dir, "inittab"), "etc")
    iopc.installBin(args["pkg_name"], ops.path_join(output_dir, "printcap"), "etc")
